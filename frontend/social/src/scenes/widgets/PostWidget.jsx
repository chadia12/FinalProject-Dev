 ...
 const PostWidget = ({
  ...
  //  const posts = useSelector((state) => state.posts);
   ...
   const patchLike = async () => {
     const response = await fetch(`https://localhost:3002/posts/${postId}/like`, {
       method: "PATCH",
       headers: {
   ...
   const patchCommt = async () => {
    const response = await fetch(`https://localhost:3002/posts/${postId}`, {
      method: "PATCH",
...
const handleGetPosts = async()=>{
 const response = await fetch("https://localhost:3002/posts", {
  method: "GET",
...
const handleDelete = async ()=>{
  const response = await fetch(`https://localhost:3002/posts/${postUserId}/${postId}`,{
    method: "DELETE",
    headers: { Authorization: `Bearer ${token}`,
    "Content-Type": "application/json"},
  });
     ...
     <WidgetWrapper m="2rem 0">
       ...
       {picturePath && (
         <img
           ...
           src={`https://localhost:3002/assets/${picturePath}`}
         />
       )}
